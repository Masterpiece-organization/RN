...
const GuestPostDetailScreen = ({navigation}) => {
  // const {isOpen, open} = useBottomSheetStore();
  const [clubInfo, setClubInfo] = useState(PROFILE_DATA.GUEST_POST_PROFILE);
...
export default GuestPostDetailScreen;
